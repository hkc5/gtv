# Evidence Files Plan - 10 Files Total
...
| albus-ui.png                           | Combined Albus UI - Top: Library view, Bottom: Search view                                                                  | MC-1          |
| albus-user.png                         | User growth showing 220K+ users signed up in past 12 months                                                                 | MC-1          |
| albus-vectordb.png                     | Albus vector database architecture/metrics showing 50K users, 400K docs, 4M chunks                                          | MC-1          |
| amazon-commits.png                     | Code contributions - 120+ changes with 360K+ lines added and 320K+ lines removed during 9 months                            | OC3-1         |
...
| hackathon.png                          | Combined hackathon recognition - KPMG National Winner and Riverhacks participation                                          | MC-3          |
| hakancan-scholar.png                   | Google Scholar profile (5 papers, 27+ citations)                                                                            | OC4-2         |
| imperial-research.png                  | Combined Imperial RAPIDS - a) slide cover, b) workflow diagram, c) GitHub repository                                        | OC4-2         |
...
| koc-mentor.png                         | Combined Koç mentoring - a) email for 2 mentee matches, b) mentorship network website, c) Tuna LinkedIn, d) Deniz LinkedIn | MC-5          |
| koc-rank1.png                          | Koç University transcript/certificate showing ranked #1 in Mechanical Engineering                                           | MC-3          |
| podcast-tutoring.png                   | Combined podcast and teaching - a) podcast interview, b) tutoring certificate, c) Girls Who Code certificate                | MC-5          |
...
| revizon.png                            | Combined Revizon app - Top: UI screenshot, Bottom: high-level system design diagram of mobile app (GCSE/A-levels AI study) | MC-5          |
| uk-grad-salary.png                     | UK graduate median salary chart (£42K comparison)                                                                           | MC-2          |
| yc.png                                 | Combined YC recognition - batch invite, AI Startup School, Monzo event                                                      | MC-3          |
...
| ----------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| MC-1-AlbusSystemImpact              | MC        | Founding Engineer at Albus - 220K+ users signed up in 12 months, 50K+ active users served by my system, system scale metrics, UI built                                                                                                                             | albus-user.png, albus-ui.png, albus-vectordb.png                                                                                                                                           | Focus on IMPACT and scale recognition - 220K signups, 4M chunks |
| MC-2-MarketValueCompensation        | MC        | Market value and compensation - Amazon package (£85K/year, 2x UK median), verified through offers, stock grants, and payslips                                                                                                                                      | amazon-offer.png, amazon-stock.png, amazon-payslips.png, uk-grad-salary.png                                                                                                                | Exceptional market value for AI/ML expertise                  |
| MC-3-AcademicCompetitiveRecognition | MC        | Academic and competitive recognition - Koç #1 ranking, YC AI Startup School (top 2K/50K), KPMG National Winner, Amazon hackathon, Riverflex scouting                                                                                                               | koc-rank1.png, yc.png, hackathon.png                                                                                                                                                       | All forms of recognition consolidated                         |
...
| MC-5-EducationalLeadership          | MC        | Mentoring & teaching - Koç mentoring (Tuna & Deniz with documented outcomes), Girls Who Code (high school girls from low income regions), course tutoring (Fluid Dynamics, Computational Methods), Revizon app mentoring (Imperial students), podcast (500+ views) | podcast-tutoring.png, koc-mentor.png, revizon.png | Comprehensive educational leadership with diversity/inclusion |
| OC3-1-PrimeVideoPerformance         | OC3       | Amazon Prime Video UI performance optimization - 20% latency reduction for 100M+ devices, 4% memory optimization, 120+ changes with 360K+ lines                                                                                                                     | amazon-latency.png, amazon-commits.png                                                                                                                                                     | Enterprise-scale performance contribution (100M+ customers)   |
...
| OC4-2-CrossInstitutionalResearch    | OC4       | Cross-institutional AI research - Imperial RAPIDS + Koç biomedical ML + Scholar profile showing full publication portfolio beyond Max Planck                                                                                                                       | hakancan-scholar.png, paper-biomedical-optics-express.png, imperial-research.png                                                                                                           | Ongoing research + full research portfolio (5 papers total)   |
...
**Total images:** 28
**Total uses:** 28 (no reuse!)

- ✅ MC-1: 3 images (user growth 220K + combined UI + vector DB showing scale)
- ✅ MC-2: 4 images (Amazon compensation package + salary comparison)
- ✅ MC-3: 3 images (Koç #1 ranking + YC combined + hackathons combined)
- ✅ MC-4: 4 images (LinkedIn recruiters + YC cofounder + Kenley offer)
- ✅ MC-5: 3 images (podcast/tutoring/GWC combined + mentoring with outcomes + Revizon)
- ✅ OC3-1: 2 images (Prime Video latency improvement + code contributions)
...
- ✅ OC4-2: 3 images (Scholar profile + Koç paper + Imperial RAPIDS combined)
...
- Focus on quantifiable metrics in captions
...
2. MC-2-MarketValueCompensation.md
3. MC-3-AcademicCompetitiveRecognition.md
...
**Total:** 10 evidence files, 28 images, zero repetition
