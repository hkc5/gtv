...
| koc-mentor-web.png                     | Koç mentoring program website screenshot                                                                                    | MC-5          |
...
| mentor-linkedin.png                    | Combined mentee outcomes - Deniz (Imperial) and Tuna (game company)                                                         | MC-5          |
...
| MC-5-EducationalLeadership          | MC        | Mentoring & teaching - Koç mentoring (Tuna & Deniz with documented outcomes), Girls Who Code (high school girls from low income regions), course tutoring (Fluid Dynamics, Computational Methods), Revizon app mentoring (Imperial students), podcast (500+ views) | koc-mentor-web.png, koc-mentor-mail.png, koc-mentor-match-mail.png, mentor-linkedin.png, koc-gwc.png, koc-tutor.png, hakancan-mechtalks-interview.png, revizon-diagram.png, revizon-ui.png | Comprehensive educational leadership with diversity/inclusion |
...
- ✅ MC-5: 9 images (mentoring + GWC + tutoring + Revizon + podcast)
...
**Total:** 10 evidence files, 35 images, zero repetition
