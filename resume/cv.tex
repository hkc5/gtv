...
\begin{document}
    ...
    \begin{itemize}
        \item Developed predictive modeling framework for earthquake impact assessment in Turkey, focusing on \textbf{viscous wall dampers} performance optimization using computational mechanics and ML techniques.
    \end{itemize>

    \section{Leadership \& Mentoring}
    \subsection{Imperial College London Leadership}{Amazon University Engagement Program}{2025}
    \begin{itemize}
        \item \textbf{3 students mentoring} through Amazon University Engagement Program, providing technical guidance and career development support.
        \item \textbf{Revizion AI application} - GCSE/A-levels studying app development supervision, leading cross-institutional collaboration.
        \item \textbf{Cross-institutional leadership} connecting industry experience with academic development for next-generation tech talent.
    \end{itemize}

    \section{Speaking \& Media Coverage}
    \subsection{Technical Presentations \& Outreach}{Industry \& Academic Engagement}{2024-2025}
    \begin{itemize}
        \item \textbf{Amazon Engineering Presentation}: "Agentic AI Tools and MCPs for Engineering Tasks" - 30+ attendees in person, \textbf{500+ online viewers}.
        \item \textbf{Koc University Podcast}: Studies and careers in the UK discussion (English) - \textbf{500+ YouTube views}, reaching international student audience.
    \end{itemize}
