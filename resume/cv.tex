...
\begin{document}
    ...
    \begin{itemize}
        \item Optimizing Prime Video UI components, reducing rendering time by 20\% for over 100M customers, improving app responsiveness on low-end devices through LLM-powered automation pipelines.
